...
const Login = () => {
  ...
  const { login, googleLogin, guestLogin, isAuthenticated } = useContext(AuthContext);
  ...
  return (
    <SignInPage 
      title="Welcome Back"
      subtitle="Sign in to your account or jump straight in"
    >
      <div className="flex flex-col gap-4 mt-4 w-full max-w-sm mx-auto">
        ...
        <div className="relative flex items-center justify-center my-1">
          ...
          <span className="bg-black px-3 text-xs text-zinc-400 font-medium uppercase tracking-wider">or sign in with email</span>
          <div className="border-t border-white/10 w-full"></div>
        </div>
