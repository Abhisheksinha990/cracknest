  ...
  return (
    ...
    >
      <div className="flex flex-col gap-6 mt-8 items-center w-full">
        {loading ? (
          <div className="text-white text-lg animate-pulse font-medium">Signing in with Google...</div>
        ) : (
          <div className="w-full flex justify-center scale-110">
            <GoogleLogin 
              onSuccess={handleGoogleSuccess}
              onError={() => toast.error("Google login failed. Check VITE_GOOGLE_CLIENT_ID or Authorized Origins.")}
              theme="filled_black"
              shape="pill"
              size="large"
